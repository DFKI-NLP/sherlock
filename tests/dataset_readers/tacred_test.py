...
def test_get_labels_ner():
    ...
    labels = list(reader.get_labels(IETask.NER, file_path=TRAIN_FILE))
...
def test_get_additional_tokens_ner():
    ...
    labels = reader.get_additional_tokens(IETask.NER, file_path=TRAIN_FILE)
    assert labels == []
...
def test_get_labels_re():
    ...
    labels = list(reader.get_labels(IETask.BINARY_RC, file_path=TRAIN_FILE))
...
def test_get_additional_tokens_re():
    ...
    additional_tokens = reader.get_additional_tokens(
        IETask.BINARY_RC, file_path=TRAIN_FILE)
